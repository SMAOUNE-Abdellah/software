...
file_put_contents('/var/www/html/saasautomation/src/php/docker-compose.yaml', $_POST['yaml']); 
$page = file_get_contents('/var/www/html/saasautomation/src/php/docker-compose.yaml');
$page = str_replace('-',' ', $page );
$page = str_replace('tiret','- ',$page);
$page = str_replace('space','-',$page);
$page = str_replace('"{{}}"','',$page);
$result=file_put_contents('/var/www/html/saasautomation/src/php/docker-compose.yaml',$page);

//Add system script to deploy the service for the client
$serverdeploy =  str_replace(" ", "" , $_POST['ip']);
