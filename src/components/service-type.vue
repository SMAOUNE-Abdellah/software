<template>
  ...
  ></v-file-input>
            ...
            <v-row v-if="select == ['Images']">
                ...
                <v-row v-if="hide">
                  <v-col cols="12" sm="12"><h2>Images Informations</h2></v-col>
                </v-row>
                <v-row v-for="image in images.number" :key="image">
                    ...
                    <v-row>
                      <v-col
                        ...
                        >
                          ...
                          label="Image Name"
                          color="brown"
                          hint="enter the name of the image"
                         required
                         clearable
                         v-model="images.name[image-1]"
                         ></v-text-field>
                        </v-col>
                        <v-col
                        cols="12"
                  ...
                  label="Image Code"
                  color="brown"
                  hint="enter the github url of the code depanding image"
                  clearable
                  v-model="images.code[image-1]"
                ></v-text-field>
                        </v-col>
                    </v-row>
                 ...
                 <v-row   v-if="hide">
                    <v-col cols="12" sm="6">
                       <v-select
                       :items=network.concat(images.name)
      ...
      creates: function(){
       ...
       createImages: function(){
        ...
        for (var i = 0; i < this.images.url.length; i++) {
          dataL.append('name[]', this.images.name[i]);
          dataL.append('url[]', this.images.url[i]);
          dataL.append('code[]',this.images.code[i]);
          }
